...
impl ShaderManager {
   ...
   pub fn add_defaults(&mut self, display : &GlutinFacade) {
      self.add_shader(display, "texture".to_string(),
                      VERT_SH_TEXTURE, FRAG_SH_TEXTURE);
      self.add_shader(display, "color-red".to_string(),
                     VERT_SH_COLOR, FRAG_SH_COLOR_R);
      self.add_shader(display, "color-green".to_string(),
                     VERT_SH_COLOR, FRAG_SH_COLOR_G);
      self.add_shader(display, "color-green".to_string(),
                     VERT_SH_COLOR, FRAG_SH_COLOR_B);
   }

   pub fn add_shader(&mut self, display : &GlutinFacade, name : String,
                     vert_sh_src : &str,
                     frag_sh_src : &str)
   {
...
pub static FRAG_SH_COLOR_R : &'static str = r#"
   #version 140
   out vec4 color;
...
pub static FRAG_SH_COLOR_G : &'static str = r#"
   #version 140
   out vec4 color;
...
pub static FRAG_SH_COLOR_B : &'static str = r#"
   #version 140
   out vec4 color;
